...
class AgentMultiScaleM2(AgentMultiScaleBasis):
    ...
    #     for item_idx in x_items_values_top.keys():
    #         if item_idx in z_values_top.keys() and item_idx not in s_top_copy.keys():
    ...
    #     var_indices = list(s_top_copy.keys())
